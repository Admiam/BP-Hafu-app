 ...
 */
export declare const fetchPredictionsWithSession: (inputText: string, filter?: Partial<AutocompleteFilter>) => Promise<AutocompletePrediction[]>;
/**
 ...
 */
export declare const fetchPlaceWithSession: <PlaceFields extends (keyof Place)[]>(placeID: string, placeFields?: PlaceFields) => Promise<Pick<Place, PlaceFields[number]>>;
export { AddressComponent, Attributions, AutocompleteFilter, AutocompletePrediction, BooleanPlaceAttribute, DayOfWeek, HoursType, LatLng, LocalTime, LocationBounds, OpeningHours, Period, PhotoMetadata, Place, PlacesBusinessStatus, PlacesPriceLevel, PlaceTypesTableOne, PlaceTypesTableThree, PlaceTypesTableTwo, PlusCode, SpecialDay, TimeOfWeek, };
